...
class UnifiedEstimator:
	def __init__(self,
	             ...
	             subtype_model=ExtraTreesClassifier(max_depth=22,
	                                                random_state=0),
	...
	def loss(self, X: pd.DataFrame, y_true: pd.DataFrame) -> Tuple[
		...
		plt.show()
		subtype_loss = f1_score(y_true_subtype, y_pred_subtype,
		                        average="macro")
